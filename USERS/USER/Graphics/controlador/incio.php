...
<form action="registro.php" method="get">
      ...
      <tr>
        ...
        <td align="right"><a href="otrografico.php"><?php echo $acu;?> </a></td>
      </tr>
      </table>
    ...
    <table width="100%">
      <tr>
        <th rowspan="2" valign="top">
          <h4 > CUADRO DE PAGOS PERIODO <?php if(@$periodo=$_GET['periodo']==""){$periodo=$tte[0];}else {@$periodo=$_GET['periodo'];} echo $periodo;?></h4> 
        </th>
