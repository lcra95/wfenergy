...
<nav class="navbar navbar-inverse navbar-fixed-top">
 ...
 <!--Aqui empieza el encabezado de menu para que se adapte a moviles-->
			<div class="navbar-header" valign="top">
			      ...
			      <a class="navbar-brand" href="inicio.php">        <img src="images/giasysblanc.png" class="img-responsive" width="80" heigth="35">
</a>
			</div>
...
<!--Aqui comienza el menu visible en pc y se relaciona con moviles a traves del id ejemplo-->			
 ...
 <!--Aqui comienza el menu con sub obciones
				       ...
				       <!-- <li class="dropdown">
				          ...
				          <ul class="dropdown-menu" role="menu">
							<li><a href="nfactura.php" ><span class="fa fa-file-text" aria-hidden="true"></span> Nueva Factura</a></li>
				        ...
				        <li class="dropdown">
				          ...
				          <ul class="dropdown-menu" role="menu">
				         	...
				         	<li><a href="#" ><span class="fa fa-money" aria-hidden="true"></span> Gestionar Pagos</a></li>
