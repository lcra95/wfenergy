               ...
               <form action="gnfactura.php?empresa=<?php echo $empresa;?>" method="post" class="form-vertical">
                <div class="panel-heading">
                  <div class="row">
                    ...
                    <select name="mes">
                      <?php $o=date('m');?>
                      <option><?php if($i<=9){ echo '0'.$o;}else{echo $o;}?></option> 
                      <?php $o=1; while($o<=12){?>
                      <?php if($o<=9){?>
                      <option>0<?php echo $o;?></option>  
                      <?php }else {?>
                    ...
                    <div class="col-sm-4">
                        <div class="input-group">
                            <span class="input-group-addon">Tipo DTE</span>
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                          <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="formGroup" placeholder="Rut" Value="<?php echo @$r;?>" >
                            <span class="input-group-btn">
                              <button class="btn btn-primary" type="button" data-toggle="modal" data-target="#ventana1">Sel.</button>
                            </span>
                          </div>
                        </div>
                        <div class="col-sm-8">
...
<table id="example" class="display" cellspacing="0" width="100%">
        ...
        <tbody>
            ...
            <tr>
                <td><a href="index.php?empresa=<?php echo $row[0];?>" class="fa fa-check-square-o"></a></td>
...
<div class="modal-body">
        ...
        <form target="_blank" action="nfacturar.php?factura=<?php echo $fac;?>" method="post" class="form-horizontal">
